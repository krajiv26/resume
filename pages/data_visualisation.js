                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="h5">Periodic Table</div>
                                        <p class="category">Periodic Table created with help of D3 js. Selecting any element will heighlight all elements in that group. Also opens up a information windows related to selected element.</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Lunar Mission</div>
                                        <p class="category">Showing all moon/lunar mission by various country around the world with time line in D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Covid Timeline</div>
                                        <p class="category">Showing World Covid timeline with play facility in D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Confusion matrix</div>
                                        <p class="category">Showing Confusion Matrix used in Data Science with D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Floating Bar Chart</div>
                                        <p class="category">Showing Floating Bar Chart - Temperature across year monthwise in D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Group Matrix Graph</div>
                                        <p class="category">Showing Group matrix graph in D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Gantt Chart</div>
                                        <p class="category">Showing Gantt Chart to display task completion status in D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">Zoomable TreeMap</div>
                                        <p class="category">Showing zoomable treemap in D3 js</p>
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2" >
                                        <div class="h5">India Demography</div>
                                        <p class="category">Showing India Poulation Density and Sex Ratio on the map of India. Also showing data table for data.</p>
